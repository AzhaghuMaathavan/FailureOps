...
import { Upload, RefreshCw, FileText, AlertCircle, CheckCircle2, Clock, PlusCircle, MessageSquare, Search, Trash2, Activity } from 'lucide-react';
import { api } from '../api';
...
interface SidebarProps {
  ...
  activeView: 'chat' | 'intelligence';
  onSelectView: (view: 'chat' | 'intelligence') => void;
}
    ...
    <>
      <div className="w-72 bg-gray-50 border-r border-gray-200 flex flex-col h-full overflow-hidden shrink-0">
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          <h1 className="font-semibold text-gray-800 text-lg">FailureOps RAG</h1>
          <button
            onClick={onRefresh}
        ...
        {/* View Switcher: Chat vs Intelligence */}
        <div className="p-2.5 bg-gray-100/80 border-b border-gray-200 grid grid-cols-2 gap-1.5">
          <button
          ...
          <button
            onClick={() => onSelectView('intelligence')}
            className={`py-1.5 px-3 text-xs font-semibold rounded-md flex items-center justify-center gap-1.5 transition-all ${
