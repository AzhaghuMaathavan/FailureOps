        ...
        if analysis:
            ...
            for sig in signal_packet.signals:
                db_sig = SignalItem(
                    ...
                    project_id=project_id,
                    name=sig.name,
                    canonical_name=sig.canonical_name or sig.name,
                    ...
                    previous_risk_score=sig.previous_risk_score,
                    baseline_risk_score=sig.baseline_risk_score,
                    risk_change_percent=sig.risk_change_percent,
                    risk_trend=sig.risk_trend,
                    scoring_method=sig.scoring_method,
                    benchmark_target=sig.benchmark_target,
                    benchmark_critical=sig.benchmark_critical,
                    unit=sig.unit,
                    baseline_value=sig.baseline_value,
                    previous_value=sig.previous_value,
                    current_value=sig.current_value,
                    baseline_timestamp=sig.baseline_timestamp,
                    previous_timestamp=sig.previous_timestamp,
                    current_timestamp=sig.current_timestamp,
                    baseline_to_current_change_percent=sig.baseline_to_current_change_percent,
                    previous_to_current_change_percent=sig.previous_to_current_change_percent,
                    metric_change_percent=sig.metric_change_percent,
                    metric_trend=sig.metric_trend,
